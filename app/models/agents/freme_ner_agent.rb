module Agents
  class FremeNerAgent < Agent
    ...
    def validate_options
      ...
      errors.add(:base, "number needs to be greater than 0 and less than or equal to 5") unless options['numLinks'].blank? || options['numLinks'] =~ /[0-5]/
    ...
    def complete_dataset
      ...
      JSON.parse(response.body).map { |dataset| { text: "#{dataset['name']}: #{dataset['description']}", id: dataset['id'] } }
    end
